      ...
      <SignUp
        ...
        appearance={{
          ...
          elements: {
            ...
            formButtonPrimary: "bg-[#bfa27a] text-[#1c1c1c] hover:opacity-90 rounded-none text-xs tracking-widest uppercase",
            formFieldInput: "bg-[#2e2929] border-[#bfa27a26] text-[#f0ebe3] rounded-none focus:border-[#bfa27a]",
            ...
            socialButtonsBlockButton: "border-[#bfa27a26] bg-[#2e2929] text-[#f0ebe3] hover:bg-[#3a3333] rounded-none",
